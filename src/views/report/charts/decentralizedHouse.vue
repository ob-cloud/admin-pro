            ...
            <div>
                <div class="search-condition clearfix">
                    <div class="search-condition-time f-fl">
                        ...
                        <a-range-picker style="margin-top: 2px;" @change="(date,dateString)=>changeDate(date, dateString)" :format="dateFormat" v-model="timeDateList"/>
                    </div>
                    ...
                    <div class="f-fl clearfix" style="margin-top: 7px">
                        ...
                        <div class="f-fl" style="margin-top: 0.5px"><dept-employee-tree placeholder="请选择部门" resMark="mk_house_decentralized" :showNameAll="false" :showEmployee="false" @selectChange="selectDept" placement="bottomRight" ref="selectDeptEmp" minWidth="250px" width="90px" ></dept-employee-tree></div>
                    </div>
                    <div class="search-condition-divider f-fl" style="width: 1px"></div>
                    ...
                    <div class="f-fl clearfix" style="margin-top: 7px">
                        ...
                        <div class="f-fl mySelectStyle">
                            <a-select v-model="sendData.houseType" placeholder="全部" style="width: 60px;margin-top: 2px" @change="changeHouseType">
