<template>
    <div class="complete-repair clearfix">
        <!-- 完成 -->
        <div class="ipt-box" style="margin-top: 20px;" :style="showSubjectFlag?'padding: 0 20px':''">
            ...
            <div class="input-info" style="margin-top:5px;">
                <label-item class="u-bottom-border" title="维修结果" :mustFill="true" style="width: 180px;">
                    <a-row style="height: 32px;line-height: 32px">
                        ...
                        <a-col :span="10" style="margin-left: 8px;"><a-checkbox v-model="unSolve" @change="onChangeUnSolve">未解决</a-checkbox></a-col>
                    </a-row>
                </label-item>
            ...
            <label-item class="u-bottom-border" :title="this.parData.completeIsSolve==0?'未解决原因':'维修内容'" :mustFill="true" style="width: 100%;margin-top:20px;" :valLength="parData.repairContent.length" :maxSize="200">
                <a-textarea style="min-height: 30px;" v-model="parData.repairContent" maxlength="200" :autosize="{ minRows: 1, maxRows: 5 }" placeholder="请输入" />
            </label-item>
                ...
                <div class="table margin-top-13">
                    ...
                    <div class="house-data u-no-border" v-for="(item,index) in repairSubject.subjectList" :key="index">
                        ...
                        <div class="clearfix" style="max-width: 118px;" :style="item.moneyUnEditable==0?'':'background:#F6F7F8;'">
                            <div style="width: 110px;padding-left: 14px;" :class="{ 'undertakerUnEditableStyle': item.moneyUnEditable==1 }">
...
export default {
    ...
    data() {
        return {
            parData: {
                ...
                completeIsSolve:1,  //维修结果：是否解决【0、否，1、是】
    ...
    methods: {
        ...
        moduleFieldConfigGet(val){
            ...
            moduleFieldConfigGet(paramter).then(res=>{
                if(res&&res.data&&res.data.fieldsObj){
                    this.repairSubject = res.data.fieldsObj;
                }
            });
        },
        cancelPreviewImage() {
        ...
        save() {
            ...
            if (!this.parData.repairContent) {
                this.$message.warning('请填写维修内容！');
                return;
            }
            //图片处理
            ...
            API.repairComplete(data).then(res => {
                if (res.code === "200") {
