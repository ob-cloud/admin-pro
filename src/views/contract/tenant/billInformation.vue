            ...
            <a-table rowKey="id" :bordered="true" :customRow="openDetail" :pagination="false" :columns="tableColumns" :dataSource="info">
                ...
                <div slot="payerName" slot-scope="text,record">
                    <div class="f-fl" type="primary">
                        <p style="line-height:22px;width:100%;">
                ...
                <div slot="predictTime" slot-scope="text,record">
                    ...
                    {{record.billStatus == 2?$moment(record.finishTime).format('YYYY.MM.DD'):$moment(text).format('YYYY.MM.DD')}}
                </div>
...
export default {
    ...
    methods: {
        ...
        getContract() {
            billSimpleList(this.tenantContract,'',this.pagination.current,this.pagination.pageSize).then(res => {
                if (res.code === '200') {
