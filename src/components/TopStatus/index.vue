<template>
    <div class="status">
        <p :class="{ active: currentActiveIndex === index ,specilLine: item.line,borderActive:currentActiveIndex === index&&showSpecilLine}" v-for="(item,index) in statusData" :key="index" @click="changeStatus(item,index)">
