        ...
        <div class="blocks" v-show="showBlock">
          <ul>
            ...
            >
              ...
              <span
                  style="margin-left:10px;color:#838383;font-size:13px"
              >{{community.address}}</span>
            </li>
          </ul>
        </div>
      </div>
      <el-amap ref="map" vid="amapDemo" :plugin="plugin" :center="mapCenter" :zoom="mapZoom" @zoomend="zoomEnd" class="amap-demo" :events="events">
