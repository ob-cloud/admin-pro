        ...
        <div class="close-source-detail">
            ...
            <div class="sign-date" v-if="closeSourceForm.status==2||closeSourceForm.status==3">
                ...
                <div class="contentSlot">
                        ...
                        <ul class="year-radio">
                            <li @click="quickSelectYear(1);">1个月</li>
                            <li @click="quickSelectYear(3);">3个月</li>
                            <li @click="quickSelectYear(6);">6个月</li>
                            <li @click="quickSelectYear(12);">1年</li>
                        </ul>
                    </div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            closeSource(){
                ...
                API.renterClueClose(this.closeSourceForm).then(res=>{
                    if (res.code === '200') {
