<template>
  <div class="bindBatchSetOne-box">
    ...
    <div style="margin-top: 25px;position: relative;">
      ...
      <div v-if="billingMethodValue==3" style="position: absolute;color: #777777;font-size: 14px;right: 0px;top: 30px;">元</div>
      <div v-else style="position: absolute;color: #777777;font-size: 14px;right: 0px;top: 30px;">元/m³</div>
    </div>
