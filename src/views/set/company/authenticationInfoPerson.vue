<template>
    <!-- 查看认证信息 -->
    <div class="authentication-person-box">
        <div class="content">
            <div class="apartment">
            ...
            <div class="content-detail">
                ...
                <div class="content-detail-line clearfix">
                    <div class="content-detail-line-title f-fl">法人身份证照：</div>
                    <div class="content-detail-line-img f-fl clearfix">
                        <label-item title="" :skeletonLoading="skeletonLoading">
                            <div v-if="picSrc1" class="f-fl cursor" style="margin-right: 10px" @click="handlePreview(picSrc1)">
                                <img :src="picSrc1" >
                                <p style="text-align: center;color: #777777;font-size: 12px;margin-top: 4px;">身份证正面</p>
                            </div>
                            <div v-else>
                                -
                            </div>
                            <div v-if="picSrc2" class="f-fl cursor" @click="handlePreview(picSrc2)">
                                <img :src="picSrc2">
                                <p style="text-align: center;color: #777777;font-size: 12px;margin-top: 4px;">身份证反面</p>
                            </div>
                            <div v-else>
                                -
                            </div>
                        ...
                        if(this.sendData.picList!=null){
                            if(this.sendData.picList&&this.sendData.picList.length>0){
                                this.sendData.picList.forEach((item)=>{
                                    if(item.subBizType == 4){
                                        this.picSrc1 = item.origin
                                    }
                                    if(item.subBizType == 5){
                                        this.picSrc2 = item.origin
                                    }
                                });
                            }
                        }
