...
<template>
    <div class="addManagerUser-box">
        <div class="empNameStyle" v-if="obj.empId">
            <span class="font1Style">账户管理人：</span><span class="font2Style">{{obj.empName}}</span>
        </div>
        <div class="contentStyle" :style="obj.empId?'margin-top:25px;':''">
            <div class="titleStyle" style="margin-top: 20px;" v-if="!obj.empId">
                账号管理人<span class="mustFillStyle">*</span>
            </div>
            <div class="clearfix" style="margin-top: 3.5px;" v-if="!obj.empId">
            ...
            <div class="titleStyle" :style="obj.empId?'':'margin-top: 30px;'">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            operationAdd(val){
                if(this.currentObj.operationList.indexOf(val)==-1){
                    this.currentObj.operationList.push(val)
                }
            },
            operationDelete(val){
            ...
            selectDeptEmp(selectObj){
                if (selectObj.type == 'employee') {
                    ...
                    this.currentObj.empName = selectObj.name;
                }
            },
            cancelSave(){
