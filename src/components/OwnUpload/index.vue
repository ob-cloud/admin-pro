<template>
    <div>
            ...
            <draggable v-model="picsList"
                ...
                <transition-group>
                    <div class="f-fl file-list" :class="styleStandard==1?'pic':styleStandard==3?'rotation':'enclosure'" @mouseenter="showBtn=true;currentActiveIndex=i"
                         @mouseleave="showBtn=false;unShowPicType=true;currentActiveIndex=-1" v-for="(item,i) in picsList" :key="i" :style="item.status!='done'?'border: 1px solid #eeeeee;':''">
                        ...
                        <div v-else :class="styleStandard==1?'pic-img-list':styleStandard==3?'rotation-img-list':'enclosure-img-list'">
                            <div @click="handlePreview(item.origin)" v-if="item.status=='done' && item.origin &&
        ...
        <div class="tips" v-if="showTips">
            ...
            <p>* 仅支持图片格式（例如：jpg、png、jpeg等），最多上传{{maxLength}}张，每张最大5M；</p>
    ...
    export default {
        ...
        methods: {
            ...
            beforeUpload(file, fileList){
              ...
              let maxSize = this.maxPicSize*1024*1024;
