<template>
    <div @click.stop="showTree=true" class="tree-wrap cursor" :class="bottomBorder ? 'u-bottom-border' : ''">
        ...
        <a-input @focus="cancelTree" autocomplete="off" v-if="!showEmployee && !disableDept" @change="onChange"
                    ...
                    >
                      <template slot="title" slot-scope="{ title }">
                        <span v-if="title.indexOf(searchValue) > -1">
                          ...
                          <span style="color: #0A87F8">{{ searchValue }}</span>
        ...
        methods: {
          onChange(e) {
            ...
            if(value){
              ...
              const expandedKeys = this.dataList
                  .map(item => {
                    if (item.value.indexOf(value) > -1) {
                      ...
                      let parentKey =  getParentKey(item.id, this.deptData);
              ...
              this.allSearchKeys.push(this.deptData[0].key);
              this.setStyle(this.deptData,this.allSearchKeys);
              Object.assign(this, {
                expandedKeys,
                searchValue: value,
                autoExpandParent: true,
              ...
              this.setStyle(this.deptData,this.allSearchKeys);
              Object.assign(this, {
                expandedKeys:[this.deptData[0].key],
                searchValue: value,
                autoExpandParent: true,
              });
            }
          ...
          getDeptTreeData() {
                ...
                PublicAPI.getAuthDeptTree(this.resMark).then(res => {
                    if (res.code == 200) {
                        ...
                        this.expandedKeys = [this.deptData[0].key];
                    }
                })
            },
