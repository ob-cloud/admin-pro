        ...
        <div class="table">
            <a-table rowKey="id" :bordered="true" :customRow="openDetail" :pagination="false" :columns="tableColumns" :dataSource="info">
                    ...
                    <div slot="promotionDesc" slot-scope="text,record">
                        <span class="typeNameStyle" v-if="record.repairTypeName">{{record.repairTypeName}}</span>
...
<script>
import { repairListForHouse } from '@/api/workorder';
export default {
    name: "tenantInfo",
    props: {
        houseId: {
    ...
    methods: {
        ...
        getInfo(){
            ...
            repairListForHouse(parameter).then(res => {
                if (res.code === '200') {
