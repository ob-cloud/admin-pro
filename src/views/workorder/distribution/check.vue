<template>
    <div class="check-distribution clearfix">
        <!-- 验收 -->
...
export default {
    ...
    methods: {
        ...
        initData(){
            API.distributionAcceptingView(this.distributionId).then(res=>{
                this.info = res.data;
                ...
                if(this.info.expenseBillList){
                    this.distributionSubject.subjectList = []
                    this.info.expenseBillList.forEach((item)=>{
                        let temp = Object.assign({},item);
                        temp.money = temp.money/100;
                        this.distributionSubject.subjectList.push(temp);
                    });
                }
            })
        },
        save() {
            ...
            API.distributionAccepting(data).then(res => {
                if (res.code === "200") {
