    ...
    export default {
        ...
        data() {
            return {
                ...
                exportUrl: '/pc2b/da/owner_contract_house/list_export',
                exportData:{},
        ...
        methods: {
            ...
            initChart(val){
                this.ownerContractHouseDataStat();
                this.initChart1Data(val);
                this.initChart2Data(val);
            },
            ownerContractHouseDataStat(){
                API.ownerContractHouseDataStat(this.sendData).then(res => {
                    if (res.code === '200') {
                        this.data1 = res.data;
                    }
                })
            ...
            initChart1Data(val){
                API.ownerContractHouseListPeriodStat(this.sendData).then(res => {
                    if (res.code === '200') {
            ...
            initChart2Data(val){
                this.chart2Data = [];
                API.ownerContractHouseListDataGroupStat(this.sendData).then(res => {
                    if (res.code === '200') {
            ...
            initTableData(){
                ...
                API.ownerContractHouseList(this.sendData).then(res => {
                    // console.log(res)
                    if (res.code === "200") {
                        if(res.data == null){
                            this.tableData.list = [];
