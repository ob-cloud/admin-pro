...
export default {
  ...
  created() {
    //初始化原数据
    this.bindForm.brand = this.bindWaterBrand;
    this.bindForm.authAccountId = this.bindWaterAuthAccountId;
  ...
  methods: {
    ...
    listUnbindSmartDevice(){
      ...
      this.sendData.houseIdList = this.bindWaterResult.failHouseIdList;
