<template>
    <div class="myDone-box">
        ...
        <!-- 租客合同详情 -->
        <a-modal destroyOnClose centered :footer="null" :maskClosable="false" width="1200px" v-model="tenantDetailsFlag" class="ownModalBorder titDialog" :title="detailsTitle" @cancel="tenantDetailsFlag=false">
            <tenant-details :bizId="bizId" :bizScene="bizScene" :fromType="fromType" :auditInstanceId="auditInstanceId" :isCcInstanceView="isCcInstanceView" :auditEmpNameList="auditEmpNameList"></tenant-details>
        </a-modal>
        <!-- 业主合同详情 -->
        <a-modal destroyOnClose centered :footer="null" :maskClosable="false" width="1200px" v-model="ownerDetailsFlag" class="ownModalBorder titDialog" :title="detailsTitle" @cancel="ownerDetailsFlag=false">
            <owner-details :bizId="bizId" :fromType="fromType" :auditInstanceId="auditInstanceId" :isCcInstanceView="isCcInstanceView" :auditEmpNameList="auditEmpNameList"></owner-details>
        </a-modal>
        <!-- 账单流水详情 -->
        <a-modal destroyOnClose centered :footer="null" :maskClosable="false" width="1200px" v-model="billWaterDetailsFlag" class="ownModalBorder titDialog" :title="detailsTitle" @cancel="billWaterDetailsFlag=false">
            <bill-water-details :bizId="bizId" :fromType="fromType" :auditInstanceId="auditInstanceId" :isCcInstanceView="isCcInstanceView" :auditEmpNameList="auditEmpNameList"></bill-water-details>
        </a-modal>
        <!-- 账单详情 -->
        <a-modal destroyOnClose centered :footer="null" :maskClosable="false" width="1200px" v-model="billDetailsFlag" class="ownModalBorder titDialog" :title="detailsTitle" @cancel="billDetailsFlag=false">
          <bill-details :bizId="bizId" :fromType="fromType" :auditInstanceId="auditInstanceId" :auditEmpNameList="auditEmpNameList" :isCcInstanceView="isCcInstanceView"></bill-details>
        </a-modal>
    </div>
</template>
